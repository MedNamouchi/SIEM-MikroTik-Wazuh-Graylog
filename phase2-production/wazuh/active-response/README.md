...
```
Subject: [WAZUH] BRUTE FORCE MikroTik - Level 10 - Router OFIR_MAIN_NEW - IP 192.168.1.50
...
```
Subject: [WAZUH] CPU HIGH - Router OFIR_MAIN_NEW - 87% usage
...
```
Subject: [WAZUH] UNEXPECTED REBOOT MikroTik - Level 12 - Router OFIR_MAIN_NEW
...
```
Subject: [WAZUH] CONFIG CHANGE MikroTik - Level 5 - Router OFIR_MAIN_NEW - User admin
